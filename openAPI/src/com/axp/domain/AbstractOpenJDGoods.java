...
public abstract class AbstractOpenJDGoods implements java.io.Serializable {
	//拼购商品 信息
	public Integer id;
	...
	public AbstractOpenJDGoods() {
		super();
	}
	public AbstractOpenJDGoods(Integer id,Integer comments, String commissionshare,
