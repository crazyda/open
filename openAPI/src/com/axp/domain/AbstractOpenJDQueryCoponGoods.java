...
public abstract class AbstractOpenJDQueryCoponGoods implements java.io.Serializable {
	...
	public AbstractOpenJDQueryCoponGoods() {
		super();
	}
	public AbstractOpenJDQueryCoponGoods(Integer id, String skuId,
