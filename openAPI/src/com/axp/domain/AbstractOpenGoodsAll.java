...
public abstract class AbstractOpenGoodsAll implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractOpenGoodsAll() {
	}

	/** minimal constructor */
	public AbstractOpenGoodsAll(String goodsEvalScore) {
		this.goodsEvalScore = goodsEvalScore;
	}

	/** full constructor */
	public AbstractOpenGoodsAll(String goodsEvalCount, String goodsEvalScore,
