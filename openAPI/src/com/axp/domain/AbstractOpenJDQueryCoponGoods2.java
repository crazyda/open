...
public abstract class AbstractOpenJDQueryCoponGoods2 implements java.io.Serializable {
	...
	public AbstractOpenJDQueryCoponGoods2() {
		super();
	}
	public AbstractOpenJDQueryCoponGoods2(Integer id, String skuId,
			...
			String adowner, String vid,String wlCommission,String wlCommissionShare,Integer random) {
		super();
		this.id = id;
		this.skuId = skuId;
