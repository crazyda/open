...
public abstract class AbstractOpenJDQueryExplosiveGoods implements java.io.Serializable {
	...
	public AbstractOpenJDQueryExplosiveGoods() {
		super();
	}
	public AbstractOpenJDQueryExplosiveGoods(Integer id, String skuId,
