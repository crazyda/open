...
public abstract class AbstractOpenGoods2 implements java.io.Serializable {
	...
	/** default constructor */
	public AbstractOpenGoods2() {
	}

	/** minimal constructor */
	public AbstractOpenGoods2(String goodsEvalScore) {
		this.goodsEvalScore = goodsEvalScore;
	}

	/** full constructor */
	public AbstractOpenGoods2(String goodsEvalCount, String goodsEvalScore,
