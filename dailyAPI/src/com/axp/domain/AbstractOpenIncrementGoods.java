...
public abstract class AbstractOpenIncrementGoods implements java.io.Serializable {
	...
	public AbstractOpenIncrementGoods() {
		super();
	}
	public AbstractOpenIncrementGoods(Integer id, String orderReceiveTime,String customParameters,String pid, String orderVerifyTime,
