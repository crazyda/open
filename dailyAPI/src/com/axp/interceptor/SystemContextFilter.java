...
public class SystemContextFilter extends HttpServlet implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
		...
		if(request.getServletContext().getAttribute("BASEPATH_IN_SESSION")==null){
			...
			//String basePath = "http://192.168.200.182:8080/daily_ref/";
		...
		//	String basePath=req.getScheme()+"://jifen.aixiaoping.cn:8080"+"/dailyRes/"; 
			
			req.getSession().getServletContext().setAttribute("RESOURCE_LOCAL_URL", basePath);
		}
