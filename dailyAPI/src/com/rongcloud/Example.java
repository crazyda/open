...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "0vnjpoad062fz";//替换成您的appkey
		String appSecret = "QyQI79nMxYcMHq";//替换成匹配上面key的secret
		...
		// 获取 Token 方法 
		TokenResult userGetTokenResult = rongCloud.user.getToken("50896", "久久人人", "http://jph.aixiaoping.cn:8080/jupinhuiRes/upload-res/phoneUploadPics/null/nomal/7522770921065912819.png");
