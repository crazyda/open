package com.yilian.payeco.client;
...
import com.yilian.payeco.tools.http.HttpClient;
import com.yilian.payeco.tools.rsa.Signatory;
/**
...
public class TransactionClientSdk {
	...
	public static String MerchantOrder(String merchantId, String merchOrderId, 
		...
		System.out.println("xiadanshuju===================");
		Log.println("url="+url+"?"+data64);	//打印下单数据\
		System.out.println("xiadanshuju===================");
